...
describe('Automation test for UP-839', () => {
    ...
    it("UP-839", function () {
        ...
        clinicStaff.clickOnDropdownUnmarked('Automation without CCPE')
        ...
        pp.setToOn('Allow existing patients to select “No Preference” for the provider')
        pp.saveButton();
        pp.openPP();
        pp.checkLogin();
        pp.proceedLogin();
        pp.checkForNoPreferenceStateOn();
