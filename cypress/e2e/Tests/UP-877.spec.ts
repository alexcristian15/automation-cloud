...
import PatientPortal, {confirm} from "../PageObject/patient-portal"
...
describe('Automation test for UP-877', () => {
    ...
    it("UP-877", function () {
        ...
        patientList.goToMedicalTab()
        patientList.checkVisibilityPersonalDetails("EKG" )
